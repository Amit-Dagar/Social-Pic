...
<title>Welcome To - Super Pic.  </title>
...
<div class="signin-form">
	...
	<div class="auto-style3">
       ...
       <form class="form-signin" method="post" id="login-form">
        ...
        <h2 class="form-signin-heading" title="Welcome To Super Pic">
		Welcome To Super Pic.</h2><hr />
	...
	<form  class="form-signin" method="post" name="posting_txt" onSubmit="return blank_post_check();" id="post_txt">
...
<option value="Private"> Only me </option> 
	...
	<div> &nbsp;<img src="img/photo&video.PNG">Photos Upload</div>
...
<?php
	...
	<tr style="color:#6D84C4;">
		...
		<?php
			...
			<td style="padding-top:15; width: 9%;">
		<form method="post">
		...
		<input type="submit" value="Unlike" name="Unlike" style="border:#FFFFFF; background:#FFFFFF; font-size:15px; color:#6D84C4;" onMouseOver="unlike_underLine(<?php echo $postid; ?>)" onMouseOut="unlike_NounderLine(<?php echo $postid; ?>)" id="unlike<?php echo $postid; ?>"/></form></td>
			...
			{?>
			<td style="padding-top:15; width: 43px;">
		<form method="post">
		<input type="hidden" name="postid" value="<?php echo $postid; ?>"/>
		<input type="hidden" name="userid" value="<?php echo $userid; ?>"/>
...
?>
	<tr>
		...
		<td  style="padding-left:8; width: 9%;" > <a href="../fb_view_profile/view_profile.php?id=<?php echo $comment_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#800000;" onMouseOver="Comment_name_underLine(<?php echo $comment_id; ?>)" onMouseOut="Comment_name_NounderLine(<?php echo $comment_id; ?>)" id="cuname<?php echo $comment_id; ?>"> (<?php echo $user_name1; ?>)</a> </td>
	<?php
		if($userid==$post_user_id)
		{ ?>
	...
	<tr>
		<td> </td>
		<td style="width: 9%" > </td>
		<td style="padding-left:7; width: 43px;" colspan="1"> &nbsp;</td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td  style="padding-left:7; width: 9%;" colspan="1"> <?php echo $cline1; ?></td>
	</tr>
	<tr>
		<td> </td>
		<td style="width: 9%" > </td>
		<td  style="padding-left:7; width: 43px;" colspan="1"> <?php echo $cline2; ?></td>
	</tr>
	<tr>
		<td> </td>
		<td style="width: 9%" > </td>
	...
	<tr>
	<td> </td>
	<td style="padding-left:17; width: 9%;"  rowspan="2">  <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;"/>    </td>
		<td bgcolor="#800000" colspan="1" style="padding-top:15;"> 
		<form method="post" name="commenting" onSubmit="return blank_comment_check()"> 
		<input type="text" name="comment_txt" placeholder="Write a comment..." maxlength="420" style="width:300px;" id="<?php echo $postid;?>"/> 
		<input type="hidden" name="postid" value="<?php echo $postid; ?>"/> 
		<input type="hidden" name="userid" value="<?php echo $userid; ?>"/> 
		<input type="submit" name="comment" style="display:none;"/> 
		</form> </td>
	</tr>
<tr><td></td><td style="width: 25px"></td><td></td></tr><tr><td></td>
		<td style="width: 9%"></td><td style="width: 43px"></td>
		<td></td></tr><tr><td></td>
			<td style="width: 9%"></td><td style="width: 43px"></td>
			<td></td></tr><tr><td></td>
			<td style="width: 9%"></td><td style="width: 43px"></td>
