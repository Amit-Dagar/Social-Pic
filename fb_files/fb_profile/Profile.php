...
<!--Status-->
<div style=" background:#FFFFFF; position:absolute; left:37%; top:65%; height:4%; width:29%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
<div style="position:absolute; left:37.2%; top:65%;"> <img src="img/Status.PNG"><input type="button" onClick="upload_close();"  value="Update Status" style="background:#FFFFFF; border:#FFFFFF;" class="auto-style1"> <img src="img/photo&video.PNG"><input type="button"  value="Add Photos" onClick="upload_open();" name="file" style="background:#FFFFFF; border:#FFFFFF;" class="auto-style1"></div>
...
<form method="post" name="posting_txt" onSubmit="return blank_post_check();" id="post_txt">
	...
	<select style="background: transparent; border-bottom:5px;" name="priority" class="auto-style1"> 
...
<!-- Photos bg-->
	...
	<div style="position:absolute; left:15%; top:106%; background:#FFFFFF; height:20%; width:20%; z-index:-1; box-shadow:0px 2px 5px 0px rgb(0,0,0);"> </div>	
...
?>
	<div style="position:absolute; left:15.5%; top:108%;"> <img src="../../fb_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img_array[0] ?>" height="90" width="78"> More+ </div>
